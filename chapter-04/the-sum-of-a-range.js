...
// RANGE FUNCTION
// Using the conditional (ternary) operator for "step" defaults
// (if condition met (?) use value "x" else (:) use value "y".
function range(start, end, step = start < end ? 1 : -1) {
  ...
  // Encountered a weird behavior - more than 1 space was added between the values.
  return numList;
}
